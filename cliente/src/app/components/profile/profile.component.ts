...
console.log(response.user.entrenador);
...
public variableimc=false;
public variablepublication=false;
public tips=true;
public rutineexercise=false;
public progreso=false;
public dieta=false;
//console.log("afuera "+ variableimc);
mostrarimc(){
this.variableimc=true;
this.variablepublication=false;
this.tips=false;
this.rutineexercise=false;
this.progreso=false;
this.dieta=false;
//console.log("boton "+ variableimc);

}
mostrarpublication(){
this.variableimc=false;
this.variablepublication=true;
this.tips=false;
this.rutineexercise=false;
this.progreso=false;
this.dieta=false;
...
mostrarrutineexercise(){

this.variableimc=false;
this.variablepublication=false;
this.tips=false;
this.rutineexercise=true;
this.progreso=false;
this.dieta=false;
