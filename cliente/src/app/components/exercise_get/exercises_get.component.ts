...
@Component({
	selector:'exercises_get',
	templateUrl:'./exercises_get.component.html',
	//provider para dentro de ella cargar los servicios que quiero tener disponible
providers:[UserService,ExerciseService]
})
 
export class Exercise_getComponent implements OnInit{
public title:string;
public identity;
public token;
public url;
...
private _exerciseService:ExerciseService
	...
	this.title='Lista de Ejercicios';
...
this._exerciseService.getPublications(this.token,page).subscribe(
response=>{
