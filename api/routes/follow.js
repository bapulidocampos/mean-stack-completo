...
var md_auth=require('../middlewares/authenticated');
 ...
 api.delete('/follow/:id',md_auth.ensureAuth,FollowController.deleteFollow);
  api.get('/following/:id?/:page?',md_auth.ensureAuth,FollowController.getFollowUsers);
   ...
   api.get('/get-my-cliente/:followed?',md_auth.ensureAuth,FollowController.getmyusercliente);
      api.get('/get-my-trainer/:followed?',md_auth.ensureAuth,FollowController.getmyuserentrenador);
