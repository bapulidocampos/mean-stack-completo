...
function savePublication(req,res){
	var params=req.body;
	var follow_clean23=[];
follow_clean23[0]="queso";
follow_clean23[1]="leche";
	if(!params.text) return res.status(200).send({message:'Debes enviar un texto'});
var food=new Food();

food.text=params.text;
food.file='null';
food.filev='null';
food.ingrediente=params.ingrediente;

//food.ingrediente=["mani"];
//publication.comentario=params.comentario;
food.trainer=params.trainer;
food.user=req.user.sub;
food.created_at=moment().unix();
//publication.comentario=params.comentario;
food.save((err,publicationStored)=>{
