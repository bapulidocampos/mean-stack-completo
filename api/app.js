...
var tipsalimentacion_routes=require('./routes/tipsalimentacion');
var Rutine_exercise_routes=require('./routes/rutine_exercise');
...
app.use('/api',tipsalimentacion_routes);
app.use('/api',Rutine_exercise_routes);
